...
workflow downSampling {
  ...
  output {
    ...
    File? read_count_2x = downSampling_02_2x.read_counts
    ...
    File? read_count_4x = downSampling_02_4x.read_counts
    ...
    File? read_count_6x = downSampling_02_6x.read_counts
    ...
    File? read_count_8x = downSampling_02_8x.read_counts
    ...
    File? read_count_custom = downSampling_02_custom.read_counts
